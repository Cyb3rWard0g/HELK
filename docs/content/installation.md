...
Pulling helk-elasticsearch (docker.elastic.co/elasticsearch/elasticsearch:7.6.1)...
...
Pulling helk-kibana (docker.elastic.co/kibana/kibana:7.6.1)...
...
Pulling helk-logstash (otrf/helk-logstash:7.6.1)...
...
{"type": "server", "timestamp": "2020-01-25T04:26:19,459Z", "level": "INFO", "component": "o.e.n.Node", "cluster.name": "helk-cluster", "node.name": "helk-1", "message": "version[7.6.1], pid[16], build[default/docker/8bec50e1e0ad29dad5653712cf3bb580cd1afcdf/2020-01-15T12:11:52.313576Z], OS[Linux/4.15.0-74-generic/amd64], JVM[AdoptOpenJDK/OpenJDK 64-Bit Server VM/13.0.1/13.0.1+9]" }
